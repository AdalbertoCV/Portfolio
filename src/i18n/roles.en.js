...
const rolesEn = {
  roles: {
    ...
    evodeps: {
      ...
      kickers: {
        what: 'The company',
        offer: 'What gets delivered',
        purpose: 'Where it is going',
        values: 'How the work runs',
        role: 'My place in it',
      },
      ...
      offer: {
        ...
        prototypes: {
          ...
          body: 'Prototyping and rollout of custom technology, from the first test through to the system running in production.',
        },
      },

      missionLabel: 'Mission',
      visionLabel: 'Vision',
      missionBody: 'Transform innovative ideas into cutting-edge technology solutions through custom software development, equipment and prototypes, guaranteeing client satisfaction with products adapted to their needs and budget. With a focus on excellence, efficiency and creativity, to drive the growth of the people who hire us.',
      ...
      values: {
        innovation: {
          title: 'Innovation',
          body: 'Continuously seek new technologies and approaches to improve the products and services on offer.',
        },
        quality: {
          title: 'Quality development',
          body: 'A commitment to building software that is efficient, functional and pleasant to use.',
        },
        team: {
        ...
        adaptability: {
          title: 'Adaptability',
          body: 'Adjust to the client’s requirements by optimising the process, to resolve whatever comes up with quality and efficiency.',
        },
        client: {
          title: 'Client focus',
          body: 'Understand and meet each client’s specific needs on every project, before proposing a solution.',
        },
        security: {
          title: 'Security',
          body: 'Prioritise security across every aspect of development, and protect confidential information.',
        },
      },
    ...
    labsol: {
      ...
      kickers: {
        ...
        learned: 'What formed me',
        role: 'Why it still counts',
      },
